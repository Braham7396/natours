        ...
        var o = function (o) {
          ...
          o.forEach(function (o) {
            e.push([o.coordinates[1], o.coordinates[0]]),
              L.marker([o.coordinates[1], o.coordinates[0]], { icon: a })
                .addTo(p)
                .bindPopup(
                  '<p>Day '.concat(o.day, ': ').concat(o.description, '</p>'),
                  { autoClose: !1, className: 'mapPopup' }
                )
                .openPopup();
          });
          var t = L.latLngBounds(e).pad(0.5);
          p.fitBounds(t), p.scrollWheelZoom.disable();
        };
        ...
        function n() {
          ...
          function d(e, r, t, o) {
            var n = r && r.prototype instanceof f ? r : f,
              ...
              u = new k(o || []);
            return s(i, '_invoke', { value: x(e, t, u) }), i;
          }
          function j(e, r, t) {
            try {
          ...
          function x(e, r, t) {
            ...
            return function (o, n) {
              ...
              for (t.method = o, t.arg = n; ; ) {
                ...
                if ('normal' === c.type) {
                  if (
                    ((s = t.done ? 'completed' : 'suspendedYield'), c.arg === m)
                  )
                    continue;
            ...
            (k.prototype = {
              ...
              finish: function (e) {
                for (var r = this.tryEntries.length - 1; r >= 0; --r) {
                  ...
                  if (t.finallyLoc === e)
                    return this.complete(t.completion, t.afterLoc), S(t), m;
                }
              },
              catch: function (e) {
                for (var r = this.tryEntries.length - 1; r >= 0; --r) {
